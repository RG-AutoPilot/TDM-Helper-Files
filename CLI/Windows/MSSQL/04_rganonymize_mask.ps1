...
$MASKING_FILE = "C:\git\Demos\TDM-Helper-Files\CLI\Windows\MSSQL\masking.json"
$OPTIONS_FILE = "C:\git\Demos\TDM-Helper-Files\CLI\Windows\MSSQL\masking-options.json"
